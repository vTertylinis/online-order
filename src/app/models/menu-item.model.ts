...
export const menuItems: MenuItem[] = [
  ...
  { id: 83, name: 'Sex on the beach', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 84, name: 'Caipiroska', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 85, name: 'Daiquiri', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 86, name: 'Zombie', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 87, name: 'Mojito', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 88, name: 'Cosmopolitan', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 89, name: 'Margarita', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 90, name: 'Caipirinha', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 91, name: 'Negroni', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 92, name: 'Aperol spritz', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 93, name: 'Mai tai', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 94, name: 'Long island', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 95, name: 'Pina colada', price: 9, category: 'Cocktails', dineInPrice: 10 },
  { id: 96, name: 'Yuzi gun', price: 10, category: 'Cocktails', description: 'Gin, pure yuzu, lemon juice, pink grapefruit soda, cinnamon', dineInPrice: 11 },
  { id: 97, name: 'Cucu splash', price: 10, category: 'Cocktails', description: 'Gin, lemon juice, cucumber liquer, falernum, ginger beer', dineInPrice: 11 },
  { id: 98, name: 'Passion paradise', price: 10, category: 'Cocktails', description: 'Vodka, pure strawberry, pure passion fruit, lemon juice', dineInPrice: 11 },
  { id: 99, name: 'Green Apple Perfume', price: 10, category: 'Cocktails', description: 'White rum, green apple liquer, falernum, lemon juice', dineInPrice: 11 },
  { id: 100, name: "Bartender's choice", price: 9, category: 'Cocktails', dineInPrice: 10 },
