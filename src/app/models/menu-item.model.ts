...
export const menuItems: MenuItem[] = [
  ...
  { id: 54, name: 'BARREL_SMALL', price: 4, category: 'BEERS' },
  { id: 55, name: 'BARREL_LARGE', price: 5, category: 'BEERS' },
  { id: 56, name: 'KAISER', price: 4, category: 'BEERS' },
  { id: 57, name: 'RADLER', price: 4, category: 'BEERS' },
  { id: 58, name: 'ALFA', price: 4, category: 'BEERS' },
  { id: 59, name: 'MYTHOS', price: 4, category: 'BEERS' },
  { id: 60, name: 'HEINEKEN', price: 4, category: 'BEERS' },
  { id: 61, name: 'AMSTEL', price: 4, category: 'BEERS' },
  { id: 62, name: 'CORONA', price: 6, category: 'BEERS' },
  { id: 63, name: 'VERGINA', price: 4, category: 'BEERS' },
  { id: 64, name: 'VERGINA_WEISS', price: 6, category: 'BEERS' },
  { id: 65, name: 'VERGINA_RED', price: 6, category: 'BEERS' },
  { id: 66, name: 'VERGINA_ZERO', price: 4, category: 'BEERS' },
  { id: 67, name: 'FIX_DARK', price: 4, category: 'BEERS' },
  { id: 68, name: 'HEINEKEN_ZERO', price: 4, category: 'BEERS' },
  { id: 69, name: 'SEVEN_SEALS', price: 5, category: 'BEERS' },
  ...
  { id: 83, name: 'Sex on the beach', price: 10, category: 'Cocktails' },
  { id: 84, name: 'Caipiroska', price: 10, category: 'Cocktails' },
  { id: 85, name: 'Daiquiri', price: 10, category: 'Cocktails' },
  { id: 86, name: 'Zombie', price: 10, category: 'Cocktails' },
  { id: 87, name: 'Mojito', price: 10, category: 'Cocktails' },
  { id: 88, name: 'Cosmopolitan', price: 10, category: 'Cocktails' },
  { id: 89, name: 'Margarita', price: 10, category: 'Cocktails' },
  { id: 90, name: 'Caipirinha', price: 10, category: 'Cocktails' },
  { id: 91, name: 'Negroni', price: 10, category: 'Cocktails' },
  { id: 92, name: 'Aperol spritz', price: 10, category: 'Cocktails' },
  { id: 93, name: 'Mai tai', price: 10, category: 'Cocktails' },
  { id: 94, name: 'Long island', price: 10, category: 'Cocktails' },
  { id: 95, name: 'Pina colada', price: 10, category: 'Cocktails' },
  { id: 96, name: 'Yuzi gun', price: 11, category: 'Cocktails', description: 'Gin, pure yuzu, lemon juice, pink grapefruit soda, cinnamon' },
  { id: 97, name: 'Cucu splash', price: 11, category: 'Cocktails', description: 'Gin, lemon juice, cucumber liquer, falernum, ginger beer' },
  { id: 98, name: 'Passion paradise', price: 11, category: 'Cocktails', description: 'Vodka, pure strawberry, pure passion fruit, lemon juice' },
  { id: 99, name: 'Green Apple Perfume', price: 11, category: 'Cocktails', description: 'White rum, green apple liquer, falernum, lemon juice' },
  { id: 100, name: "Bartender's choice", price: 10, category: 'Cocktails' },
